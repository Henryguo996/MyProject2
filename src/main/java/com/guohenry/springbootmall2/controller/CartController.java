...
public class CartController {
    ...
    public String addToCart(@PathVariable int id, // 路徑變數：商品 ID
        ...
        // 更新購物車回 Session 中（必須重新 set 才會生效）
    ...
    //  更新購物車商品數量（通常來自表單）：POST /cart/update
    ...
    //  回傳購物車總商品數量（用於右上角 icon 顯示）：GET /cart/count
